        ...
        <SwiperSlide>
          <div className={`${styles.cards_div}`}>
            <div className={`${styles.card}`}>
              <div className={styles.card_header}>
                <img
                  src="https://images.unsplash.com/photo-1627907912747-cf784f8fe876?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="person"
                  className={`${styles.photo}`}
                />
                <h2 className={`${styles.name}`}>Jeremy</h2>
        ...
        <SwiperSlide>
          <div className={`${styles.cards_div}`}>
            <div className={`${styles.card}`}>
              <div className={styles.card_header}>
                <img
                  src="https://images.unsplash.com/photo-1588453383063-37ea0b78f30f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="person"
                  className={`${styles.photo}`}
                />
                <h2 className={`${styles.name}`}>Jeremy</h2>
