...
function Info({ serviceType, headerText, headerTextRight }) {
  return (
    <div className="mini-container margin-top-medium">
      ...
      <div className={styles.text_div}>
        <p className={`${styles.text} margin-top-mini`}>
          ...
          your {serviceType} surfaces should reflect your personal style.
          Explore the diverse range of patterns, designs, and colours that our
          {serviceType} solutions offer
        </p>
      </div>
    </div>
  );
